...
Changes can be staged by author. This provides accountablility and clarity about changes. \ref{fig:stagebyauthor} shows staging a change by author using the Tree View pannel. 
