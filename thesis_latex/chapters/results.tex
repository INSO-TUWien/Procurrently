...
The branches used in the test were "bug-hunt" and "buildsystem-test". On branch bug-hunt the files /app.js and /routes/account.js were modified by inserting comments. The configured username was "Stefan Gussner". 
